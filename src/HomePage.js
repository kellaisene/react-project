...
import './homePage.css';
import homeImg from './images/the-binary-sunset.jpeg';
	...
	render() {
		...
		return (
			<div className="list-columns">
				...
				<div className="description">Welcome to the Star Wars Info Page!</div>
				<div className="description">Click a category to learn more about the Star Wars Universe!</div>
			</div>
		);
	}
}
